  ...
  return (
    <div className="bg-purpleDark font-[Work_Sans] flex flex-col items-center pt-10 pb-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full px-6">
        {/* Plan Básico */}
        <div className="border border-purple bg-[#1b1340]  shadow-md overflow-hidden h-80">
          ...
          <div className="flex flex-col items-center py-6 px-4 text-center">
            ...
            <div className="text-green text-lg font-semibold mb-2">AHORRÁ UN 20%</div>
            <div className="text-[#d1d5db] mb-2">1 landing</div>
            <div className="text-2xl font-bold text-secondary">Desde USD 200 – 400</div>
          </div>
        </div>
        ...
        {/* Plan Intermedio */}
          ...
          <div className="flex flex-col items-center py-6 px-4 text-center">
            ...
            <div className="text-green text-lg font-semibold mb-2">AHORRÁ UN 25%</div>
            <div className="text-[#d1d5db] mb-2">1 sitio optimizado</div>
            <div className="text-2xl font-bold text-secondary">Desde USD 500 – 1000</div>
          </div>
        </div>
        ...
        {/* Plan Premium */}
          ...
          <div className="flex flex-col items-center py-6 px-4 text-center">
            ...
            <div className="text-green text-lg font-semibold mb-2">AHORRÁ UN 30%</div>
            <div className="text-[#d1d5db] mb-2">1 proyecto completo</div>
            <div className="text-2xl font-bold text-secondary">Desde USD 1000 – 2000+</div>
          </div>
        </div>
      </div>
    </div>
